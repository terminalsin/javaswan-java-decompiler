...
public class BlowfishTest implements dev.sim0n.app.test.Test {
  public void run() {
    ...
    boolean successfulStringCompare = test.equals(new StringBuilder().append(encryptedString).append(encryptedString).toString());
    if (successfulStringCompare == 0) {
      throw new IllegalStateException("String comparison failed");
    }
    successfulDecrypt = decryptedString.equals("hello world 123 1605479835458");
    if (successfulDecrypt == 0) {
