...
public class Blowfish {
  ...
  private static long byteArrayToLong(byte[] buffer, int nStartIndex) {
    return (long) buffer[nStartIndex] << 56
        | ((long) buffer[nStartIndex + 1] & 255) << 48
        | ((long) buffer[nStartIndex + 2] & 255) << 40
        | ((long) buffer[nStartIndex + 3] & 255) << 32
        | ((long) buffer[nStartIndex + 4] & 255) << 24
        | ((long) buffer[nStartIndex + 5] & 255) << 16
        | ((long) buffer[nStartIndex + 6] & 255) << 8
        | (long) buffer[nStartIndex + 7] & 255;
  }
  ...
  private static class BlowfishECB {
    ...
    protected long encryptBlock(long lPlainBlock) {
      ...
      nHi ^= pbox[0];
      nLo ^=
          (sbox1[nHi >>> 24] + sbox2[nHi >>> 16 & 255] ^ sbox3[nHi >>> 8 & 255]) + sbox4[nHi & 255]
              ^ pbox[1];
      nHi ^=
          (sbox1[nLo >>> 24] + sbox2[nLo >>> 16 & 255] ^ sbox3[nLo >>> 8 & 255]) + sbox4[nLo & 255]
              ^ pbox[2];
      nLo ^=
          (sbox1[nHi >>> 24] + sbox2[nHi >>> 16 & 255] ^ sbox3[nHi >>> 8 & 255]) + sbox4[nHi & 255]
              ^ pbox[3];
    ...
    protected long decryptBlock(long lCipherBlock) {
      ...
      nHi ^= this.m_pbox[17];
      nLo ^= (this.m_sbox1[nHi >>> 24] + this.m_sbox2[nHi >>> 16 & 255]
                  ^ this.m_sbox3[nHi >>> 8 & 255])
              + this.m_sbox4[nHi & 255]
          ^ this.m_pbox[16];
      nHi ^= (this.m_sbox1[nLo >>> 24] + this.m_sbox2[nLo >>> 16 & 255]
                  ^ this.m_sbox3[nLo >>> 8 & 255])
