...
public class Blowfish {
  ...
  private static class BlowfishECB {
    ...
    protected long encryptBlock(long lPlainBlock) {
      ...
      nHi ^= pbox[0];
      nLo ^= (((sbox1[nHi >>> 24] + sbox2[(nHi >>> 16) & 0x0ff]) ^ sbox3[(nHi >>> 8) & 0x0ff])
              + sbox4[nHi & 0x0ff])
          ^ pbox[1];
      nHi ^= (((sbox1[nLo >>> 24] + sbox2[(nLo >>> 16) & 0x0ff]) ^ sbox3[(nLo >>> 8) & 0x0ff])
              + sbox4[nLo & 0x0ff])
          ^ pbox[2];
      nLo ^= (((sbox1[nHi >>> 24] + sbox2[(nHi >>> 16) & 0x0ff]) ^ sbox3[(nHi >>> 8) & 0x0ff])
              + sbox4[nHi & 0x0ff])
    ...
    protected long decryptBlock(long lCipherBlock) {
      ...
      nHi ^= m_pbox[17];
      nLo ^= (((m_sbox1[nHi >>> 24] + m_sbox2[(nHi >>> 16) & 0x0ff]) ^ m_sbox3[(nHi >>> 8) & 0x0ff])
              + m_sbox4[nHi & 0x0ff])
          ^ m_pbox[16];
      nHi ^= (((m_sbox1[nLo >>> 24] + m_sbox2[(nLo >>> 16) & 0x0ff]) ^ m_sbox3[(nLo >>> 8) & 0x0ff])
              + m_sbox4[nLo & 0x0ff])
          ^ m_pbox[15];
      nLo ^= (((m_sbox1[nHi >>> 24] + m_sbox2[(nHi >>> 16) & 0x0ff]) ^ m_sbox3[(nHi >>> 8) & 0x0ff])
              + m_sbox4[nHi & 0x0ff])
  ...
  private static String byteArrayToUNCString(byte[] data, int nStartPos, int nNumOfBytes) {
    ...
    while (nNumOfBytes > 0) {
      sbuf.setCharAt(
          nSBufPos++, (char) (((int) data[nStartPos] << 8) | ((int) data[nStartPos + 1] & 0x0ff)));
      nStartPos += 2;
      nNumOfBytes -= 2;
    }
