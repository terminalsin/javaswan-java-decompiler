...
public class EnterpriseFizzBuzzComputationTask extends AbstractFizzBuzzResultPublisherImpl
    implements Runnable {
  private final int iterations;

  public EnterpriseFizzBuzzComputationTask(final int iterations) {
  ...
  private final void execute() {
    for (int iteration = 1; iteration <= this.iterations; ++iteration) {
      final FizzBuzzComputationUnit unit = new FizzBuzzComputationUnit(iteration);
